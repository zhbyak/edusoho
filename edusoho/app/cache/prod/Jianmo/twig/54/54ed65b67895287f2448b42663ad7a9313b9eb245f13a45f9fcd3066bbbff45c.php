...
class __TwigTemplate_4d664e023f975f624f7b404c221231609d0ccf9e5007af7b27e45bb27377842c extends Twig_Template
{
...
";
  ...
  <label class=\"col-sm-2 control-label\">
    ";
            // line 69
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("course.setting.course_remind"), "html", null, true);
            echo "
  </label>
  <div class=\"col-sm-8\">
    ";
            // line 72
            $context["wechatSetting"] = _twig_default_filter($this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("wechat"), array());
            // line 73
            echo "    ";
            if (((($this->getAttribute($this->getAttribute(($context["wechatSetting"] ?? null), "templates", array(), "any", false, true), "courseRemind", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["wechatSetting"] ?? null), "templates", array(), "any", false, true), "courseRemind", array()), "")) : ("")) && (($this->getAttribute($this->getAttribute($this->getAttribute(($context["wechatSetting"] ?? null), "templates", array(), "any", false, true), "courseRemind", array(), "any", false, true), "status", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute(($context["wechatSetting"] ?? null), "templates", array(), "any", false, true), "courseRemind", array(), "any", false, true), "status", array()), 0)) : (0)))) {
                // line 74
                echo "      ";
                $context["days"] = $this->env->getExtension('AppBundle\Twig\WebExtension')->getDays($this->getAttribute($this->getAttribute($this->getAttribute(($context["wechatSetting"] ?? null), "templates", array()), "courseRemind", array()), "sendDays", array()));
                // line 75
                echo "    <div class=\"help-block course-mange-space\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("course.setting.course_remind_tip", array("%D%" => ($context["days"] ?? null), "%H%" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["wechatSetting"] ?? null), "templates", array()), "courseRemind", array()), "sendTime", array()))), "html", null, true);
                echo "
      <a class=\"\" data-container=\"body\" data-toggle=\"popover\" data-trigger=\"hover\" href=\"";
                // line 76
                echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_wechat_notification_manage");
                echo "\" target=\"_blank\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("course.setting.course_remind_change"), "html", null, true);
                echo "</a>
    </div>
    ";
            } else {
                // line 79
                echo "      <div class=\"help-block course-mange-space\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("course.setting.course_remind_not_open"), "html", null, true);
                echo "
        <a class=\"\" data-container=\"body\" data-toggle=\"popover\" data-trigger=\"hover\" href=\"";
                // line 80
                echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_wechat_notification_manage");
                echo "\" target=\"_blank\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("course.setting.course_remind_go_to_open"), "html", null, true);
                echo "</a>
      </div>
    ";
            }
...
";
    ...
    {
        return array (  258 => 83,  250 => 80,  245 => 79,  237 => 76,  232 => 75,  229 => 74,  226 => 73,  224 => 72,  218 => 69,  214 => 67,  212 => 66,  204 => 61,  200 => 60,  196 => 59,  190 => 56,  186 => 54,  184 => 53,  174 => 50,  148 => 47,  139 => 44,  133 => 40,  123 => 39,  117 => 38,  104 => 36,  98 => 35,  95 => 34,  89 => 32,  87 => 31,  82 => 29,  81 => 27,  73 => 25,  71 => 24,  65 => 22,  63 => 21,  58 => 19,  56 => 17,  53 => 16,  50 => 15,  47 => 14,  45 => 13,  37 => 8,  33 => 7,  29 => 6,  23 => 3,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("", "course-manage/marketing/set-rule.html.twig", "/Users/zhbyak/Apache/edusoho/app/Resources/views/course-manage/marketing/set-rule.html.twig");
    }
}
