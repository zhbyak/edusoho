    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/_')) {
            ...
            if (0 === strpos($pathinfo, '/_wdt') && preg_match('#^/_wdt/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => '_wdt')), array (  '_controller' => 'web_profiler.controller.profiler:toolbarAction',  '_permission' => '',  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/_profiler')) {
                ...
                if ($pathinfo === '/_profiler/purge') {
                    return array (  '_controller' => 'web_profiler.controller.profiler:purgeAction',  '_route' => '_profiler_purge',  '_permission' => '',  '_h5' => false,);
                }

                // _profiler_info
                if (0 === strpos($pathinfo, '/_profiler/info') && preg_match('#^/_profiler/info/(?P<about>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_info')), array (  '_controller' => 'web_profiler.controller.profiler:infoAction',  '_permission' => '',  '_h5' => false,));
                }
                ...
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/search/results$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_search_results')), array (  '_controller' => 'web_profiler.controller.profiler:searchResultsAction',  '_permission' => '',  '_h5' => false,));
                }

                // _profiler
                if (preg_match('#^/_profiler/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler')), array (  '_controller' => 'web_profiler.controller.profiler:panelAction',  '_permission' => '',  '_h5' => false,));
                }

                // _profiler_router
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/router$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_router')), array (  '_controller' => 'web_profiler.controller.router:panelAction',  '_permission' => '',  '_h5' => false,));
                }

                // _profiler_exception
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/exception$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_exception')), array (  '_controller' => 'web_profiler.controller.exception:showAction',  '_permission' => '',  '_h5' => false,));
                }

                // _profiler_exception_css
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/exception\\.css$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_exception_css')), array (  '_controller' => 'web_profiler.controller.exception:cssAction',  '_permission' => '',  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/_error') && preg_match('#^/_error/(?P<code>\\d+)(?:\\.(?P<_format>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => '_twig_error_test')), array (  '_controller' => 'twig.controller.preview_error:previewErrorPageAction',  '_format' => 'html',  '_permission' => '',  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/common')) {
            ...
            if ($pathinfo === '/common/subscribe/wap') {
        ...
        if (0 === strpos($pathinfo, '/course/thread/file') && preg_match('#^/course/thread/file/(?P<id>[^/]++)/player/show$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_player_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::playerShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if (0 === strpos($pathinfo, '/user/course_set')) {
                ...
                if (preg_match('#^/user/course_set/(?P<courseSetId>[^/]++)/stick$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_user_course_set_stick;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_course_set_stick')), array (  '_controller' => 'AppBundle\\Controller\\UserController::stickCourseSetAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_user_course_set_stick:

                // user_course_set_unstick
                if (preg_match('#^/user/course_set/(?P<courseSetId>[^/]++)/unstick$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_user_course_set_unstick;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_course_set_unstick')), array (  '_controller' => 'AppBundle\\Controller\\UserController::unStickCourseSetAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/edu_cloud/sms')) {
                if (0 === strpos($pathinfo, '/edu_cloud/sms_')) {
                    if (0 === strpos($pathinfo, '/edu_cloud/sms_send')) {
                        ...
                        if (0 === strpos($pathinfo, '/edu_cloud/sms_send_')) {
                            ...
                            if ($pathinfo === '/edu_cloud/sms_send_check_captcha') {
                                if ($this->context->getMethod() != 'POST') {
                                    $allow[] = 'POST';
        ...
        if (0 === strpos($pathinfo, '/open/course')) {
            // open_course_explore
            if (0 === strpos($pathinfo, '/open/course/explore') && preg_match('#^/open/course/explore(?:/(?P<category>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_explore')), array (  '_controller' => 'AppBundle\\Controller\\ExploreController::openCourseAction',  'category' => '',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/batch/tag/add$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_files_batch_tag_add')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseFileManageController::batchTagAddAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/token/(?P<token>[^/]++)/download$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_token_download')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::downloadFileByTokenAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/my')) {
            if (0 === strpos($pathinfo, '/my/c')) {
                ...
                if (0 === strpos($pathinfo, '/my/classroom')) {
                    ...
                    if ($pathinfo === '/my/classroom/questions') {
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (0 === strpos($pathinfo, '/course/thread') && preg_match('#^/course/thread/(?P<threadId>[^/]++)/ask_video/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_ask_video_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::askVideoAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/file/(?P<fileId>[^/]++)/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_file_detail')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_files_batch_tag_add
                if (preg_match('#^/course_set/(?P<id>[^/]++)/batch/tag/add$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_files_batch_tag_add')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::batchTagAddAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                // course_set_manage_question_read
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/question/read$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_read')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::readAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_question_export
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/question/export$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_export')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::exportAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                // course_set_manage_testpaper_read
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/testpaper/read$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_read')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::readAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_testpaper_export
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/export$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_export')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::exportAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/attachment')) {
            ...
            if (preg_match('#^/attachment/(?P<id>[^/]++)/direct_video_preview$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_attachment_direct_video_preview;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_direct_video_preview')), array (  '_controller' => 'AppBundle\\Controller\\File\\AttachmentController::directVideoPreviewAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        // login_wechat_qrcode
        if ($pathinfo === '/login/wechat/qrcode') {
        ...
        // testpaper_re_edit
        if (0 === strpos($pathinfo, '/testpaper/re_edit') && preg_match('#^/testpaper/re_edit/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_re_edit')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::reEditAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        // question_re_edit
        if (0 === strpos($pathinfo, '/question/re_edit') && preg_match('#^/question/re_edit/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'question_re_edit')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::reEditAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/sub')) {
            if (0 === strpos($pathinfo, '/subject')) {
                // subject_edit_template
                if (0 === strpos($pathinfo, '/subject/edit') && preg_match('#^/subject/edit/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_subject_edit_template;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'subject_edit_template')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::editTemplateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_subject_edit_template:

                // subject_option_template
                if (0 === strpos($pathinfo, '/subject/option') && preg_match('#^/subject/option/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'subject_option_template')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::optionTemplateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // subject_show_template
                if (0 === strpos($pathinfo, '/subject/show') && preg_match('#^/subject/show/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_subject_show_template;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'subject_show_template')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::showTemplateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/testpaper') && preg_match('#^/testpaper/(?P<token>[^/]++)/import_save$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_testpaper_import_save;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_import_save')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::saveImportTestpaperAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        not_testpaper_import_save:

        // questions_import_save
        if (0 === strpos($pathinfo, '/questions') && preg_match('#^/questions/(?P<token>[^/]++)/import_save$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_questions_import_save;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'questions_import_save')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::saveImportQuestionsAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        not_questions_import_save:

        if (0 === strpos($pathinfo, '/coupon')) {
            // coupon_receive
            if (preg_match('#^/coupon/(?P<token>[^/]++)/receive$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'coupon_receive')), array (  '_controller' => 'AppBundle\\Controller\\CouponBatchController::couponReceiveAction',  '_permission' =>   array (  ),  '_h5' => true,));
            }

            // coupon_resource_list
            if (preg_match('#^/coupon/(?P<batchId>[^/]++)/resource/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'coupon_resource_list')), array (  '_controller' => 'AppBundle\\Controller\\CouponBatchController::couponResourceListAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

        }

        // activity_ppt_token
        if (0 === strpos($pathinfo, '/activity/ppt/token') && preg_match('#^/activity/ppt/token/(?P<mediaId>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'activity_ppt_token')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\PptController::getPptTokenAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/oauth')) {
            // oauth2_es_authorize
            if ($pathinfo === '/oauth/authorize') {
            ...
            if ($pathinfo === '/oauth/access_token') {
            ...
            // oauth2_es_user_info
            if (0 === strpos($pathinfo, '/oauth/user_info') && preg_match('#^/oauth/user_info/(?P<userId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'oauth2_es_user_info')), array (  '_controller' => 'AppBundle\\Controller\\OAuth2\\Server\\AuthorizationController::getUserInfoAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/cloud/video')) {
                ...
                if ($pathinfo === '/admin/cloud/video/renew/modal') {
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                ...
                if ($pathinfo === '/admin/setting/open-course-setting') {
                ...
                if ($pathinfo === '/admin/setting/message-setting') {
            ...
            if (0 === strpos($pathinfo, '/admin/classroom')) {
                ...
                if (preg_match('#^/admin/classroom/(?P<id>[^/]++)/recommend$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_set_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomAdminController::recommendAction',  '_permission' =>   array (    0 => 'admin_classroom_set_recommend',  ),  '_h5' => false,));
                }

                // admin_classroom_cancel_recommend
                if (preg_match('#^/admin/classroom/(?P<id>[^/]++)/recommend/cancel$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_cancel_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomAdminController::cancelRecommendAction',  '_permission' =>   array (    0 => 'admin_classroom_cancel_recommend',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/job')) {
                ...
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/set_next_exec_time$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_set_next_exec_time')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::setNextExecTimeAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/wechat')) {
                ...
                if ($pathinfo === '/admin/wechat/auth/setting') {
                ...
                if (0 === strpos($pathinfo, '/admin/wechat/pre_auth_url') && preg_match('#^/admin/wechat/pre_auth_url/(?P<platformType>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_wechat_pre_auth_url')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\WeChatSettingController::preAuthUrlAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                if (0 === strpos($pathinfo, '/admin/wechat/notification/record')) {
                    // admin_wechat_notification_record
                    if ($pathinfo === '/admin/wechat/notification/record') {
                    ...
                    if (preg_match('#^/admin/wechat/notification/record/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_wechat_notification_record_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\WeChatNotificationController::recordDetailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                }

                // admin_wechat_fans_list
                if ($pathinfo === '/admin/wechat/fans/list') {
                ...
                if (0 === strpos($pathinfo, '/admin/wechat/notification')) {
                    ...
                    if ($pathinfo === '/admin/wechat/notification/manage') {
                    ...
                    if ($pathinfo === '/admin/wechat/notification/show') {
                    ...
                    if ($pathinfo === '/admin/wechat/notification/template/status') {
            ...
            if (0 === strpos($pathinfo, '/admin/coupon')) {
                ...
                if ($pathinfo === '/admin/coupon/generate') {
                ...
                if (0 === strpos($pathinfo, '/admin/coupon/batch') && preg_match('#^/admin/coupon/batch/(?P<batchId>[^/]++)/create$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_coupon_batch_create;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_batch_create')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::batchCreateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_admin_coupon_batch_create:

                // admin_coupon_checkprefix
                if ($pathinfo === '/admin/coupon/checkprefix') {
                ...
                if (preg_match('#^/admin/coupon/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_admin_coupon_delete:

                // admin_coupon_batch_export
                if (0 === strpos($pathinfo, '/admin/coupon/export/csv') && preg_match('#^/admin/coupon/export/csv/(?P<batchId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_batch_export')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::exportCsvAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                if (0 === strpos($pathinfo, '/admin/coupon/show')) {
                    // admin_coupon_show
                    if (preg_match('#^/admin/coupon/show/(?P<batchId>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_show')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                    // admin_coupon_show_target
                    if (0 === strpos($pathinfo, '/admin/coupon/show/target') && preg_match('#^/admin/coupon/show/target/(?P<targetType>[^/]++)/(?P<batchId>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_show_target')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::targetDetailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                }

                // admin_coupon_get_receive_url
                if (0 === strpos($pathinfo, '/admin/coupon/getreceiveurl') && preg_match('#^/admin/coupon/getreceiveurl/(?P<batchId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_get_receive_url')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::getReceiveUrlAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_coupon_query
                if ($pathinfo === '/admin/coupon/index') {
            ...
            if ($pathinfo === '/admin/setting/coupon') {
            ...
            if (0 === strpos($pathinfo, '/admin/coupon/batch')) {
                ...
                if (0 === strpos($pathinfo, '/admin/coupon/batch/chooser') && preg_match('#^/admin/coupon/batch/chooser/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_chooser')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::chooserCouponAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_coupon_chooser_resource_list
                if (preg_match('#^/admin/coupon/batch/(?P<batchId>[^/]++)/chooser/resource/list$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coupon_chooser_resource_list')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CouponBatchController::chooserResourceListAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

            }

            // admin_wechat_notification_setting_modal
            if ($pathinfo === '/admin/wechat/notification/setting_edit') {
